...
def get_Modules():
    list.append(Basis_Softwarelogik)
    list.append(UML_Applikationsdesign)
    list.append(Software_Engineering)
    list.append(Softwareentwicklung)
    list.append(Softwareprojekt)
    list.append(Datenbanken_SQL)
    list.append(Projektmanagement)
    list.append(IT_Security)
    list.append(Netzwerke)
    list.append(Web_Design_Programmierung)
    return list